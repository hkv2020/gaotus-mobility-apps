...
checks = {
    ...
    'lib/state/app_session.dart': ['recoverLocation({bool forceRestart = false})', '_gpsWatchdogTimer', "type == 'chat.message'", 'int chatAlertSequence = 0;', 'int _lastChatAlertEventId = 0;'],
